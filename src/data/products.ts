...
export const products: Product[] = [
  {
    ...
    reviewCount: 128,
    category: "Sacs",
    variants: [{ id: "noir", name: "Noir", swatch: "#1F1D1D" }],
  ...
  },
  {
    ...
    variants: [
      { id: "creme", name: "Crème", swatch: "#EFE6DC", border: "#DCCDBF" },
      { id: "rose", name: "Rose poudré", swatch: "#E3B6B6" },
      { id: "noir", name: "Noir", swatch: "#1F1D1D" },
    ],
  ...
  },
  {
    ...
    category: "Accessoires",
    variants: [
      { id: "bordeaux", name: "Bordeaux", swatch: "#7B2436" },
      { id: "noir", name: "Noir", swatch: "#1F1D1D" },
    ],
  ...
  },
  {
    ...
    reviewCount: 87,
    category: "Accessoires",
    variants: [{ id: "blanc", name: "Blanc", swatch: "#FBF8F5", border: "#DCCDBF" }],
